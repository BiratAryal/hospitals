	 ...
	 ?>
		<div class="right">
			...
			<?php 
				...
				<textarea required="required" name="results" id="results" class="form" style="height:100px; padding-left:20px;padding-top:20px;font-family:Arial;" placeholder=""></textarea>
				<br><br>
